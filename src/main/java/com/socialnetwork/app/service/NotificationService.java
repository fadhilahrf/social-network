...
/**
 * Service Implementation for managing {@link com.socialnetwork.app.domain.Notification}.
 */
@Service
@Transactional
public class NotificationService {
    ...
    @Transactional(readOnly = true)
    public List<NotificationDTO> findAllByReceiver(String login) {
        log.debug("Request to get all Notifications by Receiver");
