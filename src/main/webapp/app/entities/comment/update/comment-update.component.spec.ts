...
describe('Comment Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const author: IUser = { id: 7366 };
      comment.author = author;
      const likes: IUser[] = [{ id: 11610 }];
      comment.likes = likes;

      const userCollection: IUser[] = [{ id: 5643 }];
      jest.spyOn(userService, 'query').mockReturnValue(of(new HttpResponse({ body: userCollection })));
      const additionalUsers = [author, ...likes];
    ...
    it('Should call Post query and add missing value', () => {
      const comment: IComment = { id: 456 };
      const post: IPost = { id: 30225 };
      comment.post = post;

      const postCollection: IPost[] = [{ id: 8641 }];
    ...
    it('Should update editForm', () => {
      const comment: IComment = { id: 456 };
      const author: IUser = { id: 10814 };
      comment.author = author;
      const likes: IUser = { id: 3780 };
      comment.likes = [likes];
      const post: IPost = { id: 18437 };
      comment.post = post;
      ...
      expect(comp.usersSharedCollection).toContain(likes);
